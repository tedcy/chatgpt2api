...
class ConfigStore:
    ...
    @property
    def image_task_next_interval_secs(self) -> int:
        try:
            return max(0, int(self.data.get("image_task_next_interval_secs", 0)))
        except (TypeError, ValueError):
            return 0
    ...
    def get(self) -> dict[str, object]:
        ...
        data["image_task_next_interval_secs"] = self.image_task_next_interval_secs
